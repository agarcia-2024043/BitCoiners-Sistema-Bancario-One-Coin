...
// .NET emite el Guid con ToString() que siempre es minúsculas,
// pero normalizamos igual para blindar comparaciones futuras
const normalizeId = (id) => (id ? id.toLowerCase().trim() : null);
...
export const validateJWT = (req, res, next) => {
  ...
  try {
    ...
    req.user = {
      // ← normalizado a minúsculas para comparaciones seguras con account.userId
      id:    normalizeId(decoded[ID_CLAIM] || decoded.sub),
